...
queryChatFilterDateBegin = " AND receiveDateTime > ";
queryChatFilterDateEnd = " AND receiveDateTime < ";
queryChatFilterSearchKey = " AND text LIKE '%";
